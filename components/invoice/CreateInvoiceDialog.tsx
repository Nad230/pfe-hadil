                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Choose a project to associate with this invoice</p>
                    </div>
                  </div>
              ...
              {step === 4 && (
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between">
                    <span>Project:</span>
                    <span>
                      {projects.find(p => p.id === invoiceData.projectId)?.name || 'Not selected'}
                    </span>
                  </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 flex justify-between pt-4">
            ...
            <Button
              ...
              disabled={
                ...
                (step === 2 && !invoiceData.projectId) ||
                (step === 3 && !invoiceData.clientId) ||
